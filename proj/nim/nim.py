...
class NimAI():
    ...
    def choose_action(self, state, epsilon=True):
        ...
        cur_qvalue = self.get_q_value(state, cur_action)
        for action in actions:
            if self.get_q_value(state, action) > self.get_q_value(state, cur_action):
                cur_action = action
                cur_qvalue = self.get_q_value(state, action)
        return cur_action
